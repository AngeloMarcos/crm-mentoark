# Prompt Lovable — Marketing Digital: Redesign Profissional do Formulário de Projeção

## Objetivo
Redesenhar completamente o `ProjecaoForm.tsx` para ter aparência de produto SaaS profissional. Eliminar: emojis nos botões, cards genéricos, cores excessivas e elementos que parecem gerados por IA sem critério de design. Referência visual: Meta Ads Manager, Linear, Vercel Dashboard.

---

## Princípios do redesign

- **Sem emojis** — usar apenas ícones do lucide-react
- **Hierarquia visual clara** — tipografia e espaçamento consistentes
- **Interatividade sutil** — estados ativos com borda, não com fundo colorido excessivo
- **Paleta contida** — apenas azul como cor de destaque, resto em tons neutros
- **Densidade adequada** — não compactar demais, não desperdiçar espaço

---

## Arquivo: `src/components/marketing/ProjecaoForm.tsx` — substituição completa
...
| Antes | Depois |
|-------|--------|
| 🏠 emojis nos segmentos | Texto limpo |
| 🖼️ 📹 emojis nos formatos | Ícones lucide-react (Image, Video, etc.) |
| Cards de objetivo com gradiente excessivo | Borda sutil + azul suave ao selecionar |
| Card azul "Investimento total" muito destacado | Linha discreta dentro do bloco de investimento |
| Botões com muitas cores diferentes | Paleta única: azul para ativo, neutro para inativo |
| Formulário solto na página | Tudo agrupado em blocos com borda sutil |
| Labels grandes e chamativas | Labels em uppercase pequeno e discreto |
| Sliders de faixa etária separados e grandes | Compactados em um bloco único "Público-alvo" |

---

## Não alterar
Apenas `src/components/marketing/ProjecaoForm.tsx`. Nenhum outro arquivo.
