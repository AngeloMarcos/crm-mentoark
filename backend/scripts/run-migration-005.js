...
const sql = fs.readFileSync(
  path.join(__dirname, '..', 'migrations', '005_inbox_sync_trigger_fix_concurrency.sql'),
  'utf8'
);
...
(async () => {
  ...
  try {
    ...
    console.log('Migration 005 (fix concorrência trigger inbox) aplicada com sucesso (commit).');
  } catch (err) {
