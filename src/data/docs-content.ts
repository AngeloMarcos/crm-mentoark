    ...
    articles: [
      ...
      },
      {
        ...
        content: [
          ...
          { type: 'heading', level: 3, text: 'Configuração da IA (RAG)' },
          { type: 'paragraph', text: 'Em Configuração da IA, adicione documentos de conhecimento que o agente consulta ao responder. Tipos disponíveis:' },
          {
            type: 'table',
            headers: ['Tipo', 'Uso'],
            rows: [
    ...
    articles: [
      {
        ...
        content: [
          { type: 'list', ordered: true, items: [
            ...
            'Ir em Configuração da IA e adicionar os documentos de conhecimento (negócio, FAQ, objeções)',
