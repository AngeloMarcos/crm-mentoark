          ...
          <Tabs defaultValue="identidade">
            ...
            <TabsContent value="motor" className="space-y-5 pt-4">
              ...
              <div className="rounded-lg border p-4 bg-muted/20 space-y-3">
                ...
                {/* [AUDITORIA] LÓGICA (Sprint 1 unificação, 2026-08-07): estes 3 toggles ainda não
                    controlam nada no backend — áudio/imagem são sempre processados quando chegam
                    (decisão desta sprint: focar em unificar config, não em adicionar gating novo).
                    Nota deixada visível de propósito, pra não passar a falsa impressão de que
                    desligar aqui já bloqueia o processamento. */}
                <p className="text-xs text-amber-600 dark:text-amber-500">
                  ⚠️ Estes controles ainda não bloqueiam nada de verdade — áudio e imagem são
                  sempre processados quando chegam, independente do que estiver marcado aqui.
                </p>
